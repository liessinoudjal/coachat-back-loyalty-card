...
final class Version20260403092623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("CREATE TABLE loyalty_card (id INT AUTO_INCREMENT NOT NULL, qr_code VARCHAR(255) NOT NULL, points INT NOT NULL DEFAULT 0, current_value INT NOT NULL, target_value INT DEFAULT NULL, is_completed TINYINT(1) NOT NULL DEFAULT 0, merchant_id BINARY(16) NOT NULL COMMENT '(DC2Type:uuid)', loyalty_program_id INT NOT NULL, customer_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_EAB8BCBD7D8B1FB5 (qr_code), INDEX IDX_EAB8BCBD6796D554 (merchant_id), INDEX IDX_EAB8BCBD8364CCED (loyalty_program_id), INDEX IDX_EAB8BCBD9395C3F3 (customer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4");
        $this->addSql("CREATE TABLE loyalty_program (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, points_per_euro INT DEFAULT NULL, points_target INT DEFAULT NULL, stamp_target INT DEFAULT NULL, reward_description VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) NOT NULL DEFAULT 1, merchant_id BINARY(16) NOT NULL COMMENT '(DC2Type:uuid)', INDEX IDX_FE2C9F376796D554 (merchant_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4");
        $this->addSql("CREATE TABLE merchant (id BINARY(16) NOT NULL COMMENT '(DC2Type:uuid)', company_name VARCHAR(255) NOT NULL, email VARCHAR(180) DEFAULT NULL, stripe_customer_id VARCHAR(255) DEFAULT NULL, trial_ends_at DATETIME DEFAULT NULL, subscription_status VARCHAR(50) NOT NULL DEFAULT 'trial', user_id INT NOT NULL, UNIQUE INDEX UNIQ_74AB25E1A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4");
        $this->addSql("CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, points_earned INT NOT NULL, points_redeemed INT NOT NULL, created_at DATETIME NOT NULL, merchant_id BINARY(16) NOT NULL COMMENT '(DC2Type:uuid)', loyalty_card_id INT NOT NULL, INDEX IDX_723705D16796D554 (merchant_id), INDEX IDX_723705D1260D7293 (loyalty_card_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4");
