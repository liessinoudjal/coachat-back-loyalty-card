...
class PromotionalOfferController extends AbstractController
{
    ...
    private function formatOffer(PromotionalOffer $offer, \DateTimeImmutable $today): array
    {
        return [
            ...
            'start_notification_recipient_count' => $offer->getStartNotificationRecipientCount(),
            'ending_soon_notification_recipient_count' => $offer->getEndingSoonNotificationRecipientCount(),
            'day_before_notification_recipient_count' => $offer->getDayBeforeNotificationRecipientCount(),
