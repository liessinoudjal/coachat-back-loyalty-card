...
class MerchantProfileControllerTest extends WebTestCase
{
    ...
    public function testCreateMerchantWithoutOptionalFields(): void
    {
        $client = static::createClient();
        ...
        $payload = json_decode((string) $client->getResponse()->getContent(), true, 512, JSON_THROW_ON_ERROR);
        self::assertSame('Only Name Shop', $payload['company_name']);
    ...
    public function testPartialUpdateMerchantProfile(): void
    {
        ...
        $client->request(
            ...
            content: json_encode(['address' => '42 avenue Victor Hugo'], JSON_THROW_ON_ERROR),
        );
